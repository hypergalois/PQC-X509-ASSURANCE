...
class SlhDsaPublicKeyAidEncodingTest {
    ...
    void passTest() throws Exception {
        ...
        pqccaExtension.assertLintResult(LintResult.of(Status.PASS), new SlhDsaPublicKeyAidEncoding(), certificate);
    }

    @Test
    void naTest() throws Exception {
        X509Certificate certificate = PQCCAExtension.createECCertificate();
        pqccaExtension.assertLintResult(LintResult.of(Status.NA), new SlhDsaPublicKeyAidEncoding(), certificate);
    }
    ...
    void errorTest() throws Exception {
        ...
        X500Name issuerDN = new X500Name("CN=JZLint CA, C=DE");
        X500Name subjectDN = new X500Name("CN=PQC Certificate, C=DE");
        AlgorithmIdentifier publicKeyAID = new AlgorithmIdentifier(PQCUtils.ID_ALG_SLH_DSA_128S_SHA2, DERNull.INSTANCE);
        ...
        pqccaExtension.assertLintResult(LintResult.of(Status.ERROR), new SlhDsaPublicKeyAidEncoding(), certificate);
    }
