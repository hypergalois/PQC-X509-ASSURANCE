...
class SlhDsaKeyUsageTest {
    ...
    void passTest() throws Exception {
        ...
        pqccaExtension.assertLintResult(LintResult.of(Status.PASS), new SlhDsaKeyUsage(), certificate);
    }

    @Test
    void naTest() throws Exception {
        X509Certificate certificate = PQCCAExtension.createECCertificate();
        pqccaExtension.assertLintResult(LintResult.of(Status.NA), new SlhDsaKeyUsage(), certificate);
    }
    ...
    void errorTest() throws Exception {
        ...
        pqccaExtension.assertLintResult(LintResult.of(Status.ERROR), new SlhDsaKeyUsage(), certificate);
    }
