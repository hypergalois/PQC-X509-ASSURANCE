...
class SmpkiExtensionMandatoryTest {

    @RegisterExtension
    static CAExtension caExtension = new CAExtension();

    private SmpkiExtensionMandatory lint = new SmpkiExtensionMandatory();
    ...
    public X509Certificate createWrongCertificate(String subjectDN, PublicKey caPublicKey, X500Name issuerDN, PrivateKey caPrivateKey)
        ...
        var basicConstraints = new Extension(Extension.basicConstraints, false, bc.toASN1Primitive().getEncoded(ASN1Encoding.DER));
